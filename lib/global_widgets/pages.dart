              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                        "BMSCE UTSAV 2020 marks the advent of the new decade and aims to celebrate the significance and advances of humanity in the new decade. The theme of this edition's UTSAV is \"Neuvo Decennium\" which extrapolates as \"The New Decade\". The theme explores the limitless nature of mankind's imagination. It fosters our minds to explore and perceive the unbounded possibilities of the universe around us. The Advances in the field of technology,media,arts,culture,society,fashion,humanitarian acts, green approaches and many more are aimed to be celebrated.",
                        style:
                            new TextStyle(fontSize: 14, color: Colors.white)),
                    Text("Why Sponsor us",
                        style: new TextStyle(
